...
namespace Learning_TOM {
    class DatasetManager {
        ...
        public static void GetDatabaseInfo(string Name) {
            ...
            //Console.WriteLine("Collation: " + database.Collation);
            Console.WriteLine("CompatibilityMode: " + database.CompatibilityMode);
            // Console.WriteLine("DbStorageLocation: " + database.DbStorageLocation);
            //Console.WriteLine("IsLoaded: " + database.IsLoaded);
            // Console.WriteLine("Language: " + database.Language);
            Console.WriteLine("LastProcessed: " + database.LastProcessed);
            Console.WriteLine("LastSchemaUpdate: " + database.LastSchemaUpdate);
            //Console.WriteLine("ReadWriteMode: " + database.ReadWriteMode);
            //Console.WriteLine("Server.Name: " + database.Server.Name);
